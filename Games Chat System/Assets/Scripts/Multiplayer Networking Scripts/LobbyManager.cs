...
public class LobbyManager : MonoBehaviourPunCallbacks
{
    ...
    [Tooltip("Join Room Text, to change Text to Joining while creating the Room")]
    [SerializeField] private TMP_Text joinRoomButtonText;
    ...
    [Tooltip("Multiplayer Battle Scene")]
    ...
    public void MakeAMatch()
    {
        ...
        /// Join a Random Room
        /// </summary>
        joinRoomButtonText.text = "JOINING...";
    ...
    public override void OnJoinedRoom()
    {
        ...
        StreamChatBehaviour.instance.RoomJoinedCreateChannel(PhotonNetwork.CurrentRoom.Name);
